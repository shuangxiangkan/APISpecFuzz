...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_AddFalseToObject(object, name);

		std::string fileName = "cJSON_AddFalseToObject.cpp";
		std::string funSignature = "cJSON* cJSON_AddFalseToObject(cJSON* object, char* name)";
