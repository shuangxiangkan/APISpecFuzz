...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		std::string fileName = "cJSON_AddStringToObject.cpp";
		std::string funSignature = "cJSON* cJSON_AddStringToObject(cJSON* object, char* name, char* string)";
		...
		if(name == string)
		{
			SpecFileGeneration("name = string", fileName, funSignature);
		}
	}
