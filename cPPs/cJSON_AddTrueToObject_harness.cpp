...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_AddTrueToObject(object, name);

		std::string fileName = "cJSON_AddTrueToObject.cpp";
		std::string funSignature = "cJSON* cJSON_AddTrueToObject(cJSON* object, char* name)";
