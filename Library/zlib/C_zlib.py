...
# 创建文件夹
string_header_path = "zlib.h"  # 使用相对路径
...
default_headers_code = ('#include "zlib.h"\n'
                        '#include <string.h>\n'
                        '#include <stdio.h>\n\n')
...
typydef_names = {"z_stream", "gz_header"}
struct_map = {}
