; ModuleID = '/home/kansx/Fuzz/APISpecFuzz/Library/cJSON/Cpps_SVF/cJSON_DetachItemViaPointer/cJSON_DetachItemViaPointer_svf.c'
source_filename = "/home/kansx/Fuzz/APISpecFuzz/Library/cJSON/Cpps_SVF/cJSON_DetachItemViaPointer/cJSON_DetachItemViaPointer_svf.c"
...
define dso_local i32 @main() #0 {
  ...
  store %struct.cJSON* %6, %struct.cJSON** %3, align 8
  %7 = load %struct.cJSON*, %struct.cJSON** %2, align 8
  %8 = load %struct.cJSON*, %struct.cJSON** %3, align 8
  %9 = call %struct.cJSON* @cJSON_DetachItemViaPointer(%struct.cJSON* noundef %7, %struct.cJSON* noundef %8)
  store %struct.cJSON* %9, %struct.cJSON** %4, align 8
  ...
  %14 = load %struct.cJSON*, %struct.cJSON** %2, align 8
  call void @cJSON_Delete(%struct.cJSON* noundef %14)
...
declare dso_local %struct.cJSON* @cJSON_DetachItemViaPointer(%struct.cJSON* noundef, %struct.cJSON* noundef) #1
