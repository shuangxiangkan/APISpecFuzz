...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_GetObjectItemCaseSensitive(object, string);

		std::string fileName = "cJSON_GetObjectItemCaseSensitive.cpp";
		std::string funSignature = "cJSON* cJSON_GetObjectItemCaseSensitive(cJSON* object, char* string)";
