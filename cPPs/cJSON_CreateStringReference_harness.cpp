...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_CreateStringReference(string);

		std::string fileName = "cJSON_CreateStringReference.cpp";
		std::string funSignature = "cJSON* cJSON_CreateStringReference(char* string)";
