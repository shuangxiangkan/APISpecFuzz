...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON_bool result = cJSON_ReplaceItemInArray(array, which, newitem);

		std::string fileName = "cJSON_ReplaceItemInArray.cpp";
		std::string funSignature = "cJSON_bool cJSON_ReplaceItemInArray(cJSON* array, int which, cJSON* newitem)";
