...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_AddNullToObject(object, name);

		std::string fileName = "cJSON_AddNullToObject.cpp";
		std::string funSignature = "cJSON* cJSON_AddNullToObject(cJSON* object, char* name)";
