...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_AddBoolToObject(object, name, boolean);

		std::string fileName = "cJSON_AddBoolToObject.cpp";
		std::string funSignature = "cJSON* cJSON_AddBoolToObject(cJSON* object, char* name, cJSON_bool boolean)";
