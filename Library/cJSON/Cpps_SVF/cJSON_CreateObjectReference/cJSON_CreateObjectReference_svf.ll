; ModuleID = '/home/kansx/Fuzz/APISpecFuzz/Library/cJSON/Cpps_SVF/cJSON_CreateObjectReference/cJSON_CreateObjectReference_svf.c'
source_filename = "/home/kansx/Fuzz/APISpecFuzz/Library/cJSON/Cpps_SVF/cJSON_CreateObjectReference/cJSON_CreateObjectReference_svf.c"
...
define dso_local i32 @main() #0 {
  ...
  %6 = call %struct.cJSON* @cJSON_CreateObjectReference(%struct.cJSON* noundef %5)
  store %struct.cJSON* %6, %struct.cJSON** %3, align 8
  %7 = load %struct.cJSON*, %struct.cJSON** %3, align 8
  %8 = bitcast %struct.cJSON* %7 to i8*
  %9 = load %struct.cJSON*, %struct.cJSON** %2, align 8
  %10 = bitcast %struct.cJSON* %9 to i8*
  call void @MAYALIAS(i8* noundef %8, i8* noundef %10)
  %11 = load %struct.cJSON*, %struct.cJSON** %2, align 8
  call void @cJSON_Delete(%struct.cJSON* noundef %11)
  ret i32 0
}

declare dso_local %struct.cJSON* @cJSON_CreateObject() #1

declare dso_local %struct.cJSON* @cJSON_CreateObjectReference(%struct.cJSON* noundef) #1
