...
parson_executables_path = "/home/kansx/Fuzz/APISpecFuzz/Library/parson/Cpps"
...
def execute_executables(directory):
    for root, _, files in os.walk(directory):
        for filename in files:
            if filename.endswith("_noin"):  # 检查文件名是否以 "_noin" 结尾
...
# 调用函数来递归遍历并执行
execute_executables(parson_executables_path)
