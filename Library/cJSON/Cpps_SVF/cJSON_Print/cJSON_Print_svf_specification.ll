; ModuleID = '/home/kansx/Fuzz/APISpecFuzz/Library/cJSON/Cpps_SVF/cJSON_Print/cJSON_Print_svf.c'
source_filename = "/home/kansx/Fuzz/APISpecFuzz/Library/cJSON/Cpps_SVF/cJSON_Print/cJSON_Print_svf.c"
...
define dso_local i32 @main() #0 {
  ...
  %6 = call i8* @cJSON_Print(%struct.cJSON* noundef %5)
  store i8* %6, i8** %3, align 8
  %7 = load i8*, i8** %3, align 8
  %8 = load %struct.cJSON*, %struct.cJSON** %2, align 8
  %9 = getelementptr inbounds %struct.cJSON, %struct.cJSON* %8, i32 0, i32 7
...
declare dso_local i8* @cJSON_Print(%struct.cJSON* noundef) #1
