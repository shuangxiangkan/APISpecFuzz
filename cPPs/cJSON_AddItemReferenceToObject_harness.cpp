...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON_bool result = cJSON_AddItemReferenceToObject(object, string, item);

		std::string fileName = "cJSON_AddItemReferenceToObject.cpp";
		std::string funSignature = "cJSON_bool cJSON_AddItemReferenceToObject(cJSON* object, char* string, cJSON* item)";
