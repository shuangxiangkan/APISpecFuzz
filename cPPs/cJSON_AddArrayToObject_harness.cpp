...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_AddArrayToObject(object, name);

		std::string fileName = "cJSON_AddArrayToObject.cpp";
		std::string funSignature = "cJSON* cJSON_AddArrayToObject(cJSON* object, char* name)";
