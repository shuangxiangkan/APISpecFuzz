...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		void result = cJSON_DeleteItemFromObject(object, string);

		std::string fileName = "cJSON_DeleteItemFromObject.cpp";
		std::string funSignature = "void cJSON_DeleteItemFromObject(cJSON* object, char* string)";
