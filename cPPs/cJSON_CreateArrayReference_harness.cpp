...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_CreateArrayReference(child);

		std::string fileName = "cJSON_CreateArrayReference.cpp";
		std::string funSignature = "cJSON* cJSON_CreateArrayReference(cJSON* child)";
