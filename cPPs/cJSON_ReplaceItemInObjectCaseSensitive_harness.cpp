...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON_bool result = cJSON_ReplaceItemInObjectCaseSensitive(object, string, newitem);

		std::string fileName = "cJSON_ReplaceItemInObjectCaseSensitive.cpp";
		std::string funSignature = "cJSON_bool cJSON_ReplaceItemInObjectCaseSensitive(cJSON* object, char* string, cJSON* newitem)";
