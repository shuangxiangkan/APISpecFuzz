...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_DetachItemFromObject(object, string);

		std::string fileName = "cJSON_DetachItemFromObject.cpp";
		std::string funSignature = "cJSON* cJSON_DetachItemFromObject(cJSON* object, char* string)";
