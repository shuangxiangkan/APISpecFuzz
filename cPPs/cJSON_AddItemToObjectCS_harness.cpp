...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON_bool result = cJSON_AddItemToObjectCS(object, string, item);

		std::string fileName = "cJSON_AddItemToObjectCS.cpp";
		std::string funSignature = "cJSON_bool cJSON_AddItemToObjectCS(cJSON* object, char* string, cJSON* item)";
