...
int main() {
	...
	while (__AFL_LOOP(1000)) 
	{
		...
		cJSON* result = cJSON_DetachItemFromObjectCaseSensitive(object, string);

		std::string fileName = "cJSON_DetachItemFromObjectCaseSensitive.cpp";
		std::string funSignature = "cJSON* cJSON_DetachItemFromObjectCaseSensitive(cJSON* object, char* string)";
